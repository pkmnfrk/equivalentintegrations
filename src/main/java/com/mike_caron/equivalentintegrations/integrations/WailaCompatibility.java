        ...
        implements IWailaDataProvider
{
    ...
    public static void load(IWailaRegistrar registrar) {
        EquivalentIntegrationsMod.logger.info("Loading Waila integration");
        if (!registered){
    ...
    public static void register(){
        if (registered)
            return;
        registered = true;
        boolean ret = FMLInterModComms.sendMessage("waila", "register", "com.mike_caron.equivalentintegrations.integrations.WailaCompatibility.load");
    }
