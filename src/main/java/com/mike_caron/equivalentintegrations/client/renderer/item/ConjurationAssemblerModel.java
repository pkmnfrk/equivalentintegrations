...
public class ConjurationAssemblerModel implements IModel
{
    private static class ModelParams {
        ...
        public Set<ResourceLocation> getDependencies() {
            return Collect.asSet(normal/*, overflow*/);
        }
        ...
        public ConjurationAssemblerOverride.BakedModelParams bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
    ...
    public static final ConjurationAssemblerModel INSTANCE = new ConjurationAssemblerModel();
    ...
    public ConjurationAssemblerModel() {
        this(new ModelParams(), new ModelParams(), Optional.empty());
    }

    public ConjurationAssemblerModel(ModelParams gui, ModelParams world, Optional<ResourceLocation> particle) {
        this.gui = gui;
        this.world = world;
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        final ConjurationAssemblerOverride override = new ConjurationAssemblerOverride(bakedGui, bakedWorld, particle);
    ...
    public IModel retexture(ImmutableMap<String, String> textures) {
        ...
        return new ConjurationAssemblerModel(this.gui, this.world, newParticle);
    }
    ...
    public IModel process(ImmutableMap<String, String> customData) {
        ...
        return changed? new ConjurationAssemblerModel(newGui, newWorld, this.particle) : this;
    }
}
